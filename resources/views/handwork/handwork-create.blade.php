	...
	<div class="row">
		<div class="col">
			<ul class="breadcrumb">
				...
				<li class="breadcrumb-item active">Add handwork</li> 
			</ul>
		</div>
	</div>
</div>
	...
	<div class="col-md-12">
		<div class="card">
			...
			<div class="card-header">
				...
				<h4 class="card-title">Create New handwork
					<a class="fa fa-list float-right mt-1" href="/handwork-display" roal="button"></a>
				</h4>

			</div>
			<div class="card-body">
				<form action="/handwork-insert" method="POST" enctype="multipart/form-data">
					@csrf
					<div class="row">
						<div class="col-xl-6">
